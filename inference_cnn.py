...
def process_frame_spiga(frame, processor):
...
def main():
    ...
    model_name = 'mp_face'
    dataset = 'wflw'
    video_path = './video/blinking.mp4'
    res_video = f'./video/{model_name}_cnn_blinking.mp4'
    graphics = f'./video/{model_name}_cnn_graph.png'
    pad = (25.0, 50.0)
    ...
    spiga_processor = SPIGAFramework(ModelConfig(dataset))
